...
python -m fusa --author deterministic --reviewer rules ui   # dashboard; the left panel shows what is ready,
                                                      #   how each work product is written, and what decides each check
